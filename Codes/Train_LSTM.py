...
if __name__ == '__main__': 
     ...
     if filename.endswith(".csv"):
        ...
        with open(file_path, 'r') as file:
            ...
            if len(vectors)>max_length:
               max_length=len(vectors) # Max length to pad all the layers to have the same elngth before feeding to the LSTM model
    ...
    model = Sequential()
    model.add(LSTM(256, input_shape=(max_length, length_row), return_sequences=True)) 
