...
if __name__ == '__main__': 
    ...
    #the dataset includes layers belong to 5 classes: benign, along with thermodynamic and Z-profile attacks
    ...
    total_samples = benign_count + count_fan+ count_bed+ count_ext+count_layer
    class_weights = {
    0: total_samples / (5 * benign_count),
    1: total_samples / (5 * count_fan),
    2: total_samples / (5 * count_bed),
    3: total_samples / (5 * count_ext),
    4: total_samples / (5 *count_layer)
    ...
    alpha_vec = [class_weights[i] for i in range(5)]  
    for a in alpha_vec:
        print(a)
    ...
    model.save("Bi-LSTM_5_Classes.h5") 
