...
if __name__ == '__main__':
    ...
    #This class_weights vector should be the same as the one used during the training phase.
    #By using the same ector, you ensure that the class weights are applied consistently when calculating the focal loss during testing.
    class_weights_array=[0.14156985134940106, 8.917613636363637, 8.642621145374449,10.779532967032967, 7.604166666666667, 4.9046875,  6.673044217687075, 7.66357421875]


    model = load_model('Bi-LSTM_WCE.h5', custom_objects={'loss': weighted_categorical_crossentropy(class_weights_array),'AttentionLayer': AttentionLayer})
