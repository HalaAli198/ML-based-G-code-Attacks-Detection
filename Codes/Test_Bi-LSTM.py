...
if __name__ == '__main__':
    ...
    #max_length=1445
    max_length=9865 #9865 # 9920, 9892
    max_file_name=None
    length_row=0
    ...
    alpha_vec = [0.14156985134940106, 8.917613636363637,8.642621145374449,10.779532967032967, 7.604166666666667, 4.9046875,6.673044217687075, 7.66357421875] 
 
    for a in alpha_vec:
        print(a)


    model = load_model('Bi-LSTM.h5', custom_objects={'focal_loss_fixed': focal_loss(alpha_vec),'AttentionLayer': AttentionLayer})
